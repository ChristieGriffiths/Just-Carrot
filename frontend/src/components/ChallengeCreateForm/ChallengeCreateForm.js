...
const ChallengeCreateForm = ({token, setToken, setViewForm, setShowPaymentMessage } ) => {
  ...
  useEffect(() => {
    ...
    console.log(challenge, completeDate, completeTime, incentiveAmount, chosenCharity, chosenValidation, paymentIntentId);
    ...
    // console.log(paymentIntentId, token, challenge, completeDate, completeTime, incentiveAmount, chosenCharity, chosenValidation, setToken, setViewForm);
  },[paymentIntentId, token, challenge, completeDate, completeTime, incentiveAmount, chosenCharity, chosenValidation, setToken, setViewForm]);
